...
\x1b[1;97m [\x1b[1;92m•\x1b[1;94m•\x1b[1;97m] Github   : https://github.com/nazareva/nazareva-1
...
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Github   : https://github.com/nazareva/nazareva-1
...
def nazareva():
    ...
    if yayan == "": 
       os.system("python nazareva-1.py")
    else:
...
def moch_yayan():
    ...
    nazareva=input("\x1b[1;97m [\x1b[1;94m•\x1b[1;91m•\x1b[1;97m] \033[90m►\033[1;93m ")
    if nazareva == "1" or nazareva =="01":
         ...
         nazareva()
    elif nazareva == "0" or nazareva =="00":
         aahh("\n\033[1;92m Thank you for using my tools.\n  Don't forget to subscribe to My YouTube Channel\n\n")
         os.system('xdg-open https://youtube.com/channel/UCS7oHOu5H6nZbSmxSfnT56A')
         exit()                   	
